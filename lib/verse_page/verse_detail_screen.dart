...
class _GitaVersePageState extends State<GitaVersePage> {
  ...
  static const double fontSizeMeaning = 9.0;
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          toolbarHeight: 40.0, // Smaller app bar
          title: Text(
          ...
          children: [
            ...
            child: Column(
              ...
              child: Column(
                ...
                // Navigation buttons added to the scrollable content
                // instead of being fixed at the bottom
        ...
        // Removed bottomNavigationBar since we've moved the navigation buttons into the scrollable content
      ),
    );
  }
    ...
    return Padding(
      ...
      children: [
        ...
        style: TextStyle(
          ...
          color: color1,
          fontWeight: FontWeight.bold,
          fontSize: _GitaVersePageState.fontSizeTiny -2,
        ),
        ),
      ],
      ),
  ...
  String _normalizeSanskrit(String word) {
    return word
      ...
      .replaceAll('ś', 's')
      .replaceAll('ṣ', 's')
      // Visarga and other rare marks
      .replaceAll('ḥ', 'h')
      .replaceAll('ẖ', 'h')
      .replaceAll('ḫ', 'h')
      // Additional rare character
      .replaceAll('ḻ', 'l');
    }
                ...
                Row(
                  ...
                  children: [
                    Text(
                      word,
                      style: TextStyle(
                        fontSize: isPart ? fontSizeMeaning + 6 : fontSizeMeaning + 8,
